...
The feature is inspired by bullet journaling, and originally first implemented in [Sanctum](https://github.com/jdanielmourao/obsidian-sanctum) by @jdanielmourao for Obsidian.

...
import animationsDemo from '../../../media/demos/interface_animation.gif';

<img src={animationsDemo.src} alt="Animations in Primary" />
...
If you're not fond of these animations, you can turn them off inside Primary Theme Settings (via [Style Settings](obsidian://show-plugin?id=obsidian-style-settings) plugin).

...
![Primary for Obsidian on Desktop - Light Mode](/src/public/assets/previews/desktop-1_light-mode.png)

![Primary for Obsidian on Desktop - Light Mode](/src/public/assets/previews/desktop-2_light-mode.png)

![Primary for Obsidian on Desktop - Light Mode](/src/public/assets/previews/desktop-3_light-mode.png)

#### Tablet

![Primary for Obsidian on Tablet - Light Mode](/src/public/assets/previews/tablet-1_light-mode.png)

#### Mobile

![Primary for Obsidian on Mobile - Light Mode](/src/public/assets/previews/mobile-1_light-mode.png)

### Dark Mode

#### Desktop

![Primary for Obsidian on Desktop - Dark Mode](/src/public/assets/previews/desktop-1_dark-mode.png)

![Primary for Obsidian on Desktop - Dark Mode](/src/public/assets/previews/desktop-2_dark-mode.png)

![Primary for Obsidian on Desktop - Dark Mode](/src/public/assets/previews/desktop-3_dark-mode.png)

#### Tablet

![Primary for Obsidian on Tablet - Dark Mode](/src/public/assets/previews/tablet-1_dark-mode.png)

#### Mobile

![Primary for Obsidian on Mobile - Dark Mode](/src/public/assets/previews/mobile-1_dark-mode.png)
